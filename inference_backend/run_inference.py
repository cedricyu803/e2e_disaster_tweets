...
import yaml
from src.train.feature_extract import run_feature_extraction
from src.train.model_train import train_model
...
if __name__ == "__main__":
    ...
    model_assets_dir = config.get('model_assets_dir', MODEL_ASSETS_DIR)
